...
export const categories: categoryType[] = [
  {
    ...
    description:
      "Here are the latest features we've added to Home Ruler Productions. We're constantly improving our services to better serve you.",
    // A short version of the description above, only displayed in the <Header /> on mobile. Up to 60 characters.
    descriptionShort: "Latest features added to Home Ruler Productions.",
  },
  {
    ...
    description:
      "Learn more about our videography and film production process with these step-by-step guides.",
    descriptionShort:
      "Learn more about our videography and film production process.",
  },
];
...
export const articles: articleType[] = [
  {
    ...
    title: "Introducing Supabase to Home Ruler Productions",
    // The description of the article to display in the article page. Up to 160 characters. It's also used to generate the meta description.
    description:
      "Supabase is an open-source Firebase alternative. It's a great tool for building a backend for your app. It's now integrated with Home Ruler Productions!",
    ...
    image: {
      ...
      alt: "Supabase and Home Ruler Productions logo combined",
    },
  ...
  CONSTRAINT users_pkey PRIMARY KEY (id)
        ...
        <section>
          <h3 className={styles.h3}>2. Add your credentials to Home Ruler Productions</h3>
          <p className={styles.p}>
            Copy the <span className={styles.codeInline}>API URL</span> and{" "}
            <span className={styles.codeInline}>API Key</span> from your
            Supabase project settings and add them to your Home Ruler Productions project
